...
from utils.func import get_user_data, screenshot, thumbnail, get_video_metadata, local_file_has_video_stream
    ...
    try:
        ...
        if m.media:
            ...
            try:
                ...
                is_actual_video = True
                mtd = None
                if looks_like_video:
                    is_actual_video = await local_file_has_video_stream(f)
                    if is_actual_video:
                        mtd = await get_video_metadata(f)
